      ...
      <div>
          <section className="pt-20  md:h-[100vh] pb-5 container bg-primary text-white">
              <div className="flex flex-col md:flex-row gap-8 w-full h-full">
                  ...
                  <div className="flex flex-col gap-4 justify-center items-start md:w-[37%] md:ml-12">
                      ...
                      <p className="md:text-2xl text-lg architect">
          ...
          <section className="container pt-12 pb-6  md:h-[100vh] bg-[#F2F2F2FF]">
              <div className="flex mb-3 flex-col md:flex-row items-center justify-center h-full w-full gap-6">
                  ...
                  >
                      <h1 className="md:text-6xl text-2xl text-primary font-bold text-center mb-4">
                          A-propos
                      </h1>
                      ...
                      <p className="text-start md:text-2xl text-xl">
                          Laurence Noubissi, notre Gérante Associée, vous invite
                          à explorer notre gamme étendue de produit & services
                          et de formations, conçus pour répondre aux besoins
                          spécifiques de chaque Entreprise cliente.
                      </p>
                      <p className="text-start md:text-2xl text-xl">
                          Depuis plus d'une décennie, nous façonnons les
                          parcours de succès de nos partenaires avec passion et
                          précision.
                      </p>
                  </div>
                  <div
          ...
          <section className="container">
              <div className="flex flex-col items-center gap-10 pt-12 pb-6">
                  <h1 className="md:text-5xl text-3xl font-bold text-primary text-center mb-4">
                  ...
                  >
                      ...
                      <div className="flex flex-col  md:w-[45%] w-full gap-4">
                          ...
                          <p className="text-xl">
                              ...
                              d'entreprise et l'évaluation des opportunités
                              d'investissement à la transformation
                              organisationnelle et la restructuration
                              stratégique, nous sommes le levier de votre
                              réussite.
                          </p>
                          <div className="md:w-40 w-full">
                              <Link to={"/preambule"}>
                  ...
                  >
                      <div className="flex flex-col md:w-[45%] w-full gap-4 ml-2">
                          ...
                          <p className="text-xl mt-2">
                              ...
                              des outils de gestion et de sécurité des données,
                              nous transformons le potentiel en expertise
                              tangible.
                          </p>
                          <div className="md:w-40 w-full">
                              <Link to={"/preambule"}>
