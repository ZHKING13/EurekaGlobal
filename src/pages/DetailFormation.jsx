        ...
        <div className="container flex flex-col gap-9">
            ...
            <section className=" mt-5 flex md:flex-row flex-col gap-6 ">
                <div className="flex justify-between w-full md:flex-row flex-col items-start gap-10">
                    ...
                    <div className="md:w-[50%] pt-0 flex justify-start items-start flex-col gap-5 w-full">
                        <div className="">
                            <h2 className=" heading ">AVAntages du MODULE :</h2>
                        </div>
                        <div className="flex flex-col w-[97%] items-start gap-2">
                            {formation?.avantage &&
                                formation?.avantage.map((item, index) => {
                                    return (
                                        <div
                                            key={item}
                                        ...
                                        >
                                            <img
                                                ...
                                                alt=""
                                            />
                                            <p className="textNormal capitalize  text-secondary">
                                                {item}
                                            </p>
                                        </div>
                                    );
            ...
            <section className=" mt-5 flex md:flex-row flex-col gap-6 ">
                <div className="flex justify-between w-full md:flex-row flex-col items-start gap-10">
                    ...
                    <div className="md:w-[50%] md:pt-9  flex justify-start items-start flex-col gap-5 w-full">
                        ...
                        <div className="flex flex-col w-[97%] items-start gap-2">
                            {formation?.benefice &&
                                formation?.benefice.map((item, index) => {
                                    return (
                                        <div
                                            key={item}
                                            className="flex  gap-4 items-center justify-center"
                        ...
                        <div className=" md:pt-9 flex items-start flex-col gap-5 w-full">
                            ...
                            <p className=" w-[97%]">
                                <span className="textNormal ">
                                    {formation?.soulagement1}
                                </span>{" "}
                                <span className="textNormal font-bold">
                                    {formation?.soulagement2}{" "}
                                </span>
                            </p>
                        </div>
                    </div>
            ...
            <div className="w-full -mt-2 mb-8 flex justify-center gap-8">
                {currentProductIndex > 0 && (
                    <Link
                        to={`/formations/${
                            Formations[currentProductIndex - 1]?.id
                        }`}
                    >
                        <Button
                ...
                {currentProductIndex < Formations.length - 1 ? (
                    <Link
                        to={`/formations/${
                            Formations[currentProductIndex + 1]?.id
                        }`}
