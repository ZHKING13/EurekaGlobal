...
const [api, contextHolder] = notification.useNotification();
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.fullName || !formData.email || !formData.phone || !formData.societe || !formData.effectif) {
      openNotificationWithIcon('warning',"Veuillez remplir tous les champs requis.")

      return;
    }

    if (formData.phone.length < 8) {
      openNotificationWithIcon('warning',"Le numéro doit contenir au moins 8 caractères.")
