...
const CtaSection = ({ produit, home }) => {
    ...
    const formationDesc =
        "Contactez-nous dès maintenant pour personnaliser votre programme de formation et commencer votre voyage vers le succès. Nous sommes là pour vous soutenir à chaque étape. ";
    ...
    const productDesc =
        "Contactez-nous dès maintenant pour discuter de la façon dont nous pouvons répondre à vos besoins spécifiques et vous aider à atteindre vos objectifs. Nous sommes là pour vous accompagner à chaque étape de votre parcours vers le succès.";
    return (
            ...
            <div className=" mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col gap-8 lg:flex-row justify-between items-center">
                    <div className="lg:w-[80%]">
                        <h1 className="md:title text-3xl font-bold text-white mb-4">
                            {produit ? productTile : formationTile}{" "}
                        </h1>
                        <p className="textNormal mb-8">
                            {produit ? productDesc : formationDesc}{" "}
                        </p>
                        {home && (
                    ...
                    <div className="lg:w-1/2 lg:ml-12 relative">
                        ...
                        <img
                            src="/lamp.png"
                            alt="Tailwind CSS"
                            className="absolute md:top-8 top-1"
                        />
                    </div>
                </div>
            </div>
