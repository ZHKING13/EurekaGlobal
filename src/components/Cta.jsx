...
const CtaSection = ({produit}) => {
    ...
    const productLink= "Cliquez ici pour commander nos produits & services"
    const productDesc = "Contactez-nous dès aujourd'hui pour discuter de la façon dont nous pouvons répondre à vos besoins spécifiques et vous aider à atteindre vos objectifs. Nous sommes là pour vous accompagner à chaque étape de votre parcours vers le succès."
    return (
