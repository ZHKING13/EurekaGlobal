                        ...
                        <div className="flex md:w-[100%] justify-center flex-col md:flex-row gap-8   ">
                            <div className="md:ml-5 flex items-center justify-center md:w-1/2 border-l  ">
                                <div className="px-4 md:ml-[60px] py-4 ">
                                    ...
                                    <ul
                                        className={`flex flex-col text-sm gap-0`}
                                    >
                                        <Link
                                            to="/preambule/Investisseurs"
                                            className="cursor-pointer flex items-center gap-2  transition-all duration-300 hover:translate-x-[2px]"
                                        >
                                            <FaCaretRight className="text-secondary text-2xl" />{" "}
                                            Investissseurs
                                        </Link>
                                        <Link
                                            to="/preambule/Startups"
                                            className="cursor-pointer flex items-center gap-2  transition-all duration-300 hover:translate-x-[2px]"
                                        >
                                            <FaCaretRight className="text-secondary text-2xl" />{" "}
                                            Startups
                                        ...
                                        <Link
                                            to="/preambule/Tres-Petites-Entreprises"
                                            className="cursor-pointer flex items-center gap-2  transition-all duration-300 hover:translate-x-[2px]"
                                        >
                                            <FaCaretRight className="text-secondary text-2xl" />{" "}
                                            TPEs
                                        ...
                                        <Link
                                            to="/preambule/Petites-Moyennes-Entreprises"
                                            className="cursor-pointer flex items-center gap-2  transition-all duration-300 hover:translate-x-[2px]"
                                        >
                                            <FaCaretRight className="text-secondary text-2xl" />{" "}
                                            PMEs
                                        ...
                                        <Link
                                            to="/preambule/Grandes-Entreprises"
                                            className="cursor-pointer flex items-center gap-2  transition-all duration-300 hover:translate-x-[2px]"
                                        >
                                            <FaCaretRight className="text-secondary text-2xl" />{" "}
                                            Grandes Entreprises
                                        ...
                                        <Link
                                            to="/preambule/Personnalites-Publiques"
                                            className="cursor-pointer flex items-center gap-2  transition-all duration-300 hover:translate-x-[2px]"
                                        >
                                            <FaCaretRight className="text-secondary text-2xl" />{" "}
                                ...
                                <div className="px-4 py-4 text-sm ">
                                    ...
                                    <ul className="flex flex-col text-sm gap-0">
                                        <Link
                                            ...
                                            className="cursor-pointer flex items-cente gap-2 r transition-all duration-300 hover:translate-x-[2px]"
                                        >
                                        ...
                                        <Link
                                            to="/formations"
                                            className="cursor-pointer flex gap-2 items-center transition-all duration-300 hover:translate-x-[2px]"
                                        >
                                            <FaCaretRight className="text-secondary text-xl" />{" "}
                                            Formations à la Carte
                                        </Link>
                                        <Link
                                            to="/produits-services/MPRF2024"
                                            className="cursor-pointer flex gap-2 items-center transition-all duration-300 hover:translate-x-[2px]"
                                        >
                                            <FaCaretRight className="text-secondary text-xl" />{" "}
